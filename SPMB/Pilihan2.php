...
<head>
  ...
  <div class="container-fluid">
	...
	<h1 style="margin-left:30px;">Pilihan Prodi Kedua</h1>
</head>
<body>

<form action="Pilihan2.php" method="post">
...
<?php
  ...
  if(isset($_POST['pil-submit'])){
    ...
    $dapat="SELECT * FROM pilihan_2";
    if(mysql_query($dapat)){
      $insert="INSERT INTO pilihan_2 VALUES ('$pil2','$nopendaft')";
