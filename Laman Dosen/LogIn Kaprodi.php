...
{  
    ...
    $check_user="select USERNAME_KAPRO, PASS_KAPRO from prodi WHERE USERNAME_KAPRO='$Nomer' AND PASS_KAPRO='$Pass'";  
    ...
    {  
       echo "<script>window.open('Laman Kaprodi/Laman Kaprodi.php','_self')</script>";
	}
    else  
    {  
...
?>
						...
						<div class="tab-pane active" id="login">
               			<form class="form-signin" action="Login Kaprodi.php" method="post">
